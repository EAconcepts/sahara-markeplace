  ...
  return (
    <div className="lg:rounded-[24px] flex flex-col bg-[#F9E79F99] text-blackPrimary font-openSans h-[268px] w-[155px] lg:h-[394px] lg:w-[294px] px-[8px] lg:px-[16px] rounded-[12px] py-[12px]">
      <Image
        ...
        height={180}
        alt={story.title}
        className="lg:w-[270px] w-[167px] bg-white h-[102px] lg:h-[180px] lg:rounded-[16px] rounded-[8px]"
      />
      <div className="pt-[4px] flex flex-col gap-y-[12px] lg:px-[4px]">
        ...
        <div className="flex justify-between">
          <button onClick={()=>router.push(`/blogs/${encodeURIComponent(story?.url)}`)} className="w-fit text-[12px] lg:text-[16px] font-[600] leading-[23.2px] ">
            Read More...
          </button>
