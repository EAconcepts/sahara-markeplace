...
const ProductHeader = ({heading, showBtn=true}:{heading: string; showBtn?: boolean}) => {
  return (
    <div className="flex gap-x-[12px]  items-baseline">
        <h2 className="font-[700] shrink-0 text-[20px] lg:text-[30px] leading-[29px] lg:leading-[43.5px] font-playfair text-blackPrimary">
          {heading}
        </h2>
        <div className="w-full border-[1px] h-[1px] border-[#E4E7EC] "></div>
      {showBtn &&  <Button variant={"outline"} className="flex items-center max-lg:h-fit max-lg:px-[8px] max-lg:py-[4px] max-lg:rounded-[8px] gap-x-[4px]">
