...
const ForgotPassword = ({ url = "" }: { url?: string }) => {
  ...
  const step1Mutation = useMutation({
    mutationFn: () =>
      axios.post(`${baseUrl}${url && url}/reset-password/initiate`, {
  ...
  const step2Mutation = useMutation({
    mutationFn: () =>
      axios.post(`${baseUrl}${url && url}/reset-password/verify-token`, {
        email: resetDetails.email,
  ...
  const step3Mutation = useMutation({
    mutationFn: () =>
      axios.post(`${baseUrl}${url && url}/reset-password/send`, {
        email: resetDetails.email,
        token: resetDetails.token,
