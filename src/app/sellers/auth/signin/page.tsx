...
const Signin = () => {
  ...
  return (
    <div className="flex w-full flex-col max-lg:mt-[24px] max-lg:flex-col lg:pb-[300px] lg:pt-[40px]">
      <div className="flex w-full gap-x-[24px] px-[24px] max-lg:flex-col lg:px-[96px]">
        ...
        <form
          ...
          className="flex flex-col font-openSans max-lg:mt-[40px] lg:w-[90%] lg:px-[40px]"
        >
