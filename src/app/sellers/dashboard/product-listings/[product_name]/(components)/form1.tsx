    ...
    <div className="flex h-full w-full flex-col gap-[24px] pb-[24px]">
            ...
            {product?.image ? (
              <>
                <Image
                  ...
                  className="h-[192px] w-[132px] rounded-[8px] border-[1px] border-dashed border-border object-cover"
                />
                <Delete03Icon
                  onClick={() => setImage("")}
                  className="absolute bottom-[8px] right-[8px] size-[16px] text-[#E8112D]"
                />
              </>
            ) : (
              image && (
      ...
      <div className="flex flex-col gap-y-[24px] rounded-[12px] border-[1px] border-border px-[16px] py-[24px]">
        ...
        <div className="flex flex-col gap-y-[12px] lg:gap-y-[24px]">
          ...
          <textarea
            placeholder={prdtDetails?.description}
            name={"description"}
            onChange={(e) =>
            ...
            className="h-[] w-full rounded-[12px] border-[1px] border-border p-[8px] text-[14px] font-[600] leading-[20.3px] text-blackPrimary"
          />
        </div>
        {/* MAterial  */}
        {product?.material && (
        ...
        <div className="flex w-full items-center justify-between gap-[24px]">
          <div className="flex w-full flex-col gap-y-[12px] lg:gap-y-[24px]">
            ...
            <Input
              ...
              placeholder={prdtDetails?.category}
              className="h-[] w-full text-[14px] font-[600] leading-[20.3px] text-blackPrimary"
            />
          </div>
          {/* Sub Category */}
        ...
        <div className="it flex justify-between gap-[24px]">
          {/* {product?.quantity && */}
          <div className="flex w-full flex-col gap-y-[12px] lg:gap-y-[24px]">
            <h5 className="text-[14px] font-[600] leading-[20.3px] text-blackPrimary">
              Quantity
