  ...
  return (
    <div className="flex flex-col gap-y-[8px] rounded-[8px] bg-[#F9E79F99] px-[24px] py-[16px] font-openSans">
      <div className="flex items-center gap-x-[8px]">
        ...
        <span className="text-[14px] lg:text-[16px] font-[600] leading-[23.2px] text-blackPrimary">
          Your account is not yet active
        </span>
      </div>
      <pre className="text-wrap break-words max-lg:line-clamp-3 font-openSans text-[12px] lg:text-[14px] font-[400] leading-[17.4px] lg:leading-[20.3px] text-blackPrimary">
        Hi Juan, <br />
      ...
      <button className="lg:hidden self-start text-[12px] text-blackPrimary font-[600] leading-[17.4px] mt-[-8px]">Read more...</button>
      <p className="text-[12px] lg:text-[14px] font-[400] leading-[20.3px] text-blackPrimary">
