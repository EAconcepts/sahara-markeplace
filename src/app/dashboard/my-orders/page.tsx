  ...
  return (
    <div className="w-full pt-[24px]">
      ...
      {isPending ? (
        ...
        <h4 className="mt-[24px] text-center text-[16px]">
              ...
              >
                ...
                <td className="pr-[15px]">
                  <div className="flex items-center gap-x-[32px] align-middle">
                    <span
                      className={` ${order?.current == "pending" ? "bg-[#F9E79F66]" : order?.current == "shipped" ? "bg-yellow-200" : order?.current == "delivered" ? "bg-success text-white" : "bg-[#8E97A6] text-white"} w-fit shrink-0 rounded-[24px] bg-[#F9E79F66] px-[16px] py-[4px] font-[600]`}
                    >
                      {order?.current}
                    </span>
        ...
        <h4 className="mt-[24px] text-center text-[16px]">An error occured!</h4>
      )}
      {/* Mobile */}
