    ...
    <div className="lg:pt-[40px]">
      ...
      <div className="mt-[32px] flex max-lg:flex-col gap-x-[24px]">
        ...
        <div className="flex w-full flex-col gap-y-[12px]">
          <h4 className="px-[24px] text-[16px] lg:text-[20px] font-[600] leading-[24px] tracking-[-2%] text-blackPrimary">
            Recent Orders
          </h4>
        ...
        {/* Default Address */}
        <div className="flex w-full max-lg:mt-[16px] lg:w-[400px] shrink-0 flex-col gap-y-[12px]">
