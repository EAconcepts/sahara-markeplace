...
const BlogCard = ({blog}:{blog:any}) => {
  ...
  return (
    <div className=" border-[1px] lg:w-[405.33px] flex flex-col gap-y-[16px] h-[387px] border-border rounded-[12px] pb-[24px] bg-white" >
    <Image src={`${imgBaseUrl}/${blog?.image}`} width={382} height={200} alt={blog?.title} className="h-[200px] object-cover lg:w-[405.33px] w-full rounded-t-[8px] rounded-r-[8px] "/>
    <div className="flex flex-col px-[16px] gap-[24px] ">
        <div className="flex flex-col gap-y-[8px]">
            <h4 className="text-[16px] font-[600] leading-[23.2px] text-blackPrimary line-clamp-1">{blog?.title}</h4>
